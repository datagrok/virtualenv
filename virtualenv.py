...
def install_activate(home_dir, bin_dir, prompt=None):
    ...
    if is_win or is_jython and os._name == 'nt':
        ...
        files = {'activate': ACTIVATE_SH,
                 'inve': INVE_PY,
                 'shell_activation_commands': SHELL_ACTIVATION_COMMANDS_PY,
    ...
    make_exe(os.path.join(bin_dir, 'shell_activation_commands'))
...
##file shell_activation_commands.py
SHELL_ACTIVATION_COMMANDS_PY = convert("""

""")

##file inve.py
INVE_PY = convert("""

9xsBtrNZ8g87YPd4
""")
...
##file activate.sh
ACTIVATE_SH = convert("""

""")
